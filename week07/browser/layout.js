...
function layout(element) {
    ...
    if (style.flexDirection === "row-reverse") {
        ...
        mainEnd = 'left';
        mainSign = -1;
        mainBase = style.width;  // container的宽度,总宽度
    ...
    if (!style[mainSize]) {// 父元素没有mainsize
    ...
    if (mainSpace < 0) {
        // overflow (happens only if container is single line), scale every line
